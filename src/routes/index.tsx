...
<body>
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      <div className="mx-auto flex w-full max-w-[1280px] flex-col gap-4 px-3 py-4 sm:px-4 lg:px-6">
        <header className="grid gap-3 rounded-lg border bg-card p-4 md:grid-cols-[minmax(0,1fr)_auto] md:items-start">
          <div className="min-w-0 space-y-1">
            <h1 className="text-xl font-semibold sm:text-2xl">Astoreka MTO</h1>
            <p className="text-sm text-muted-foreground">
              Mantenimiento y reparaciones domésticas con diagnóstico claro.
            </p>
            <p className="text-xs text-muted-foreground">
              El trabajo no acaba al realizarlo: también hay que cobrar y dejar historial.
            </p>
          </div>
        ...
        <section className="flex gap-2 overflow-x-auto pb-1">
          ...
          >
            <DialogTrigger asChild>
              <Button size="sm" className="ml-auto shrink-0" onClick={() => setNewDialog("aviso")}>
                <Plus />
                Nuevo
              </Button>
            </DialogTrigger>
            ...
            <Card>
              ...
              <CardContent className="grid gap-3 lg:grid-cols-3 xl:grid-cols-6">
                {Object.entries(jobsByGroup).map(([groupKey, groupJobs]) => (
                  <div key={groupKey} className="space-y-2 rounded-md border bg-background p-2">
                    ...
                    <div className="space-y-2">
                      {groupJobs.slice(0, 4).map((job) => (
                        ...
                        >
                          ...
                          <p className="text-muted-foreground">{job.symptoms}</p>
                        </Button>
                      ))}
                    </div>
                  </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-2">
                  {needsAttention.map((job) => (
                    <div
                      key={job.id}
                      className="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-2 rounded-md border p-2 text-sm"
                    >
                      <div className="min-w-0">
                      ...
                      <Badge variant={job.status === "facturado" ? "destructive" : "secondary"}>
                        {job.status}
                      </Badge>
                    </div>
                  ))}
          ...
          <section className="grid gap-4 xl:grid-cols-[minmax(0,1fr)_minmax(360px,420px)]">
            <Card className="min-w-0">
              <CardHeader>
                ...
                <CardDescription>Lista + filtros + acciones por fila.</CardDescription>
              </CardHeader>
            ...
            <Card className="min-w-0">
              <CardHeader>
                ...
                <CardDescription>Resumen, acciones y tabs operativos.</CardDescription>
              </CardHeader>
              <CardContent>
                {!selectedJob ? (
                  ...
                  <div className="space-y-3">
                    <div className="grid gap-2 rounded-md border p-3">
                      ...
                      <p className="text-xs">Dirección: {selectedJob.address || "Sin dirección"}</p>
                    ...
                    <div className="rounded-md border bg-secondary/40 p-3">
                      <p className="text-xs text-muted-foreground">Siguiente acción recomendada</p>
                        ...
                        {selectedJob.totals.total <= 0 ? (
                          ...
                          <>
                            <div className="rounded-md border p-2">
                              ...
                              <p>Materiales: {formatCurrency(selectedJob.totals.materialsSale)}</p>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Si afecta al estado real del negocio, vive primero en la app/base de datos. Si
                      es comunicación, repetición o integración, puede vivir en n8n.
                    </p>
                  </div>
                )}
              </CardContent>
        ...
        {section === "agenda" && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Vista diaria/semanal por técnico con acciones rápidas.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-2">
              {jobs
                .filter((job) => ["programado", "en_camino", "en_curso"].includes(job.status))
                .map((job) => (
                  <div
                    key={job.id}
                  ...
                  >
                    <div className="min-w-0 text-sm">
                      <p className="truncate font-medium">
                        {job.code} · {job.scheduledAt}
                      </p>
                      <p className="truncate text-xs text-muted-foreground">
                        {job.technician} · {job.address || "Sin dirección"}
                      </p>
                    </div>
        ...
        {section === "informes" && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Estado operativo, facturación y averías repetidas.</CardDescription>
            </CardHeader>
        ...
        {section === "ajustes" && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Roles, tarifas base y webhooks preparados para n8n.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-3 text-sm">
              ...
              <div className="rounded-md border p-3">
                ...
                <p className="text-muted-foreground">
                  ...
                  presupuesto enviado, presupuesto aprobado, parte cerrado, factura pendiente, cobro
                  recibido, stock bajo, próxima revisión.
                </p>
              </div>
            </CardContent>
          </Card>
